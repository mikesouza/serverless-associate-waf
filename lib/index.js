...
class AssociateWafPlugin {
  ...
  async getRestApiId() {
    ...
    if (!stackResource) {
      ...
      const stackResource = await this.findStackOutputByLogicalId(stackName, REST_API_ID_KEY)
      if (stackResource && stackResource.OutputValue) {
        return stackResource.OutputValue
      }
    }
