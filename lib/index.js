...
class AssociateWafPlugin {
  ...
  async findStackResourceByLogicalId(stackName, logicalId) {
    ...
    const result = outputs.find(({ OutputKey }) => OutputKey === logicalId).OutputValue;
    return result;
  }
  ...
  async getRestApiId() {
    ...
    const stackResource = await this.findStackResourceByLogicalId(stackName, REST_API_ID_KEY)
